...
## Оглавление
- [Запуск и пререквизиты](#запуск-и-пререквизиты)
    - [Быстрый запуск](#быстрый-запуск)
    - [Выставление пользовательских настроек](#выставление-пользовательских-настроек)
    - [Запуск на удаленом сервере с использованием `ngrok`](#запуск-на-удаленом-сервере-с-использованием-ngrok)
  
- [Техническая реализация проекта](#техническая-релизация-проекта)
    - [Маршрутизация](#routing)
    - [База данных](#database)
    - [Шаблоны](#templates)
    - [Фабрика приложения](#factory)
  
- [О процессе реализации](#о-процессе-реализации)
    - [Проблемы, которые у нас возникли](#проблемы-которые-у-нас-возникли)
    - [Процесс разработки](#процесс-разработки)
    - [Описание функционала](#описание-функционала)
    - [Методология `Git flow`](#методология-git-flow)
...
##### [Инициализируйте базу данных и запустите приложение на локальном сервере](#выставление-пользовательских-настроек)
